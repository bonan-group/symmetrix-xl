...
def test_rejects_invalid_screening_coefficients():
    with pytest.raises(ValueError, match="four screening coefficients"):
        symmetrix.ZBLKokkos(0.3, 0.4543, [1.0], [0.0, 0.5], 6)
