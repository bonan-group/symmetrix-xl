...
try:
    ...
    from mace.modules import extensions as mace_extensions
    from mace.tools.scripts_utils import remove_pt_head

    if not hasattr(mace_extensions, "MACEField"):
        raise ImportError("mace.modules.extensions.MACEField is not available")
