...
|---|---|---|---|---|
| `direct` | Compact standard MACE and MACEField with admitted contracts; compatible compact MACE-MH-1 | Serial, OpenMP, CUDA, HIP | R1 artifact required for two-interaction models; single-layer models use built-in R1 execution, but capacity may specialize M0/R0 | Standard MACE and MACEField; R1 artifact required for two-interaction models, but not single-layer models; MACE-MH-1 is not supported |
