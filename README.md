...
and extends it with native execution paths for CPUs and GPUs. The Python
distribution is named `symmetrix-xl`; the import namespace and command-line
interface remain `symmetrix`.
...
[`symmetrix` package README](symmetrix/README.md) for backend-specific builds.
